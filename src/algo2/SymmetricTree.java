...
public class SymmetricTree {
    public static boolean isSymmetric(algo.TreeNode root){
        if (null == root){
            return true;
        }
        return helper(root.left,root.right);
    }
    public static boolean helper(algo.TreeNode left, algo.TreeNode right){
    ...
    public static void main(String[] args) {
        ...
        algo.TreeNode root = con.buildTreeByBfs(in);
        con.preOrder(root);
